...
void highscore_leaderboard(){
    ...
    ///if(level == 3) timebonus=(max(0, (sawraz_dibe-time_elapsed))) * 100;
    ///level complete kore ekbar dekhe nao kotokkhon lagtese.
    lifebonus=life * 500;
...
//        if(level==1)
    ...
    if(deathtimer > 0) {
        //iRectangle(400, 300, 200, 100);
        //iText(425, 325, "Dead!", GLUT_BITMAP_TIMES_ROMAN_24);
...
//    if(leaderboardnum>1){
//        iShowBMP2(453, 359, "Games//2.bmp", 0xffffff);
//        iText(548, 383, leaderboardname[1], GLUT_BITMAP_TIMES_ROMAN_24);
//        iText(775, 383, leaderboardscores[1], GLUT_BITMAP_TIMES_ROMAN_24);
//    }
...
void iDraw(){
    //if(!(level == 1 || level == 2)) printf("time elapsed: %d\n", time_elapsed);
    if(level == -101701){
        iLeaderBoard();
        return;
    }
