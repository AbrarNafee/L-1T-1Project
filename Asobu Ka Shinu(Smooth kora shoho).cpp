...
int main(){
    ...
    iSetTimer(20,change);  /*iSetTimer(20,change1);  iSetTimer(20,minechange);*/ iSetTimer(25,smooth); iSetTimer(80,ko); iSetTimer(50,checkshow);
    if(main_menu){
        if(sound==1)PlaySound("Musix\\main menu.wav",NULL,SND_LOOP | SND_ASYNC);
    }
